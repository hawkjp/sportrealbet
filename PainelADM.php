  ...
  <div class="col-lg-12">
    <div class="card mb-4 shadow">
      <div class="card-header">
        <span style="font-weight: bold;">Gerentes</span>
      </div>
      <div class="card-body">
        <div class="row mb-2">
          <div class="col-sm-2">
        ...
        <div class="row">
          <div class="col-sm-12 mb-3">
            <input type="text" id="managerFilter" class="form-control" onkeyup="filterFunction()" placeholder="Pesquisar gerente...">
          </div>
        </div>
...
<!-- Modal funcionario/gerente FIM -->

<script src="ModelJS/painelADM.js"></script>
<script>
  ...
  function filterFunction() {
    ...
    input = document.getElementById("managerFilter");
    filter = input.value.toUpperCase();
    cardContainer = document.getElementById("managerList");
